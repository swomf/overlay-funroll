...
# If you're looking in this ebuild due to a cyclic dependency conflict,
# first install with just the ASTAL[io] USE flag; the other astal libs
# need this in order to be bootstrapped.
...
if [[ ${PV} == 9999 ]]; then
	...
	GIT_COMMIT="2c5eb54f39e1710c6e2c80915a240978beb3269a"
...
RDEPEND="
	...
	battery? ( dev-libs/json-glib sys-power/upower )
...
PATCHES=("${FILESDIR}"/hyprland-v0.55-backport.patch)
